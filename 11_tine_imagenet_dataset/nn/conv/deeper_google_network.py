...
class DeeperGoogleNet:
    ...
    @staticmethod
    def conv_module(x, K, kX, kY, stride, chanDim, padding: str = "same", reg=0.0005, name=None):
    ...
    def inception_module(x, num1x1, num3x3Reduce, num3x3, num5x5Reduce, num5x5, num1x1Proj, chanDim, stage, reg=0.0005):
        ...
        fourth = MaxPooling2D((3, 3), strides=(
            1, 1), padding="same", name=stage + "_pool")(x)
    ...
    @staticmethod
    def build(width, height, depth, classes, reg=0.0005) -> Model:
        inputShape = (height, width, depth)
        chanDim = -1
        if "channels_first" == B.image_data_format():
        ...
        x = Activation("softmax", name="gsoftmax")(x)
